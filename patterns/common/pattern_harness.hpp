// patterns/common/pattern_harness.hpp
//
// Base test harness for LPDDR5 memory pattern tests
//
...
/// Base test harness for memory controller patterns
///
/// Provides:
...
public:
    explicit PatternHarness(const LPDDR5MemoryController::Config& config)
        : config_(config)
    ...
    virtual ~PatternHarness() = default;
