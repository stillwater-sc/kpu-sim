// patterns/memory/hbm3e/common/hbm3e_harness.hpp
//
// HBM3E-specific test harness for pattern validation
//
...
inline fs::path get_trace_dir(const std::string& category) {
    ...
    fs::path trace_dir = root / "traces" / "memory" / "hbm3e" / category;
...
/// HBM3E variant enumeration
enum class HBM3EVariant {
    HBM3E_8400,  // 8.4 Gbps @ 4.2 GHz
    HBM3E_9600   // 9.6 Gbps @ 4.8 GHz
};

/// Get clock frequency for variant
inline double get_clock_ghz(HBM3EVariant variant) {
    switch (variant) {
        case HBM3EVariant::HBM3E_8400: return CLOCK_GHZ_8400;
        case HBM3EVariant::HBM3E_9600: return CLOCK_GHZ_9600;
    }
    return CLOCK_GHZ_9600;  // Default
}

/// Get variant name string
inline std::string get_variant_name(HBM3EVariant variant) {
    switch (variant) {
        case HBM3EVariant::HBM3E_8400: return "HBM3E-8400";
        case HBM3EVariant::HBM3E_9600: return "HBM3E-9600";
    }
    return "HBM3E";
}

/// Get peak bandwidth for variant
inline double get_peak_bandwidth(HBM3EVariant variant) {
    switch (variant) {
        case HBM3EVariant::HBM3E_8400: return HBM3E_8400_BANDWIDTH;
        case HBM3EVariant::HBM3E_9600: return HBM3E_9600_BANDWIDTH;
    }
    return HBM3E_9600_BANDWIDTH;
}

/// HBM3E-specific test harness for memory controller patterns
///
/// Provides:
...
class HBM3EHarness {
public:
    explicit HBM3EHarness(const HBM3MemoryController::Config& config,
                          HBM3EVariant variant = HBM3EVariant::HBM3E_9600)
        : config_(config)
        , variant_(variant)
    ...
    virtual ~HBM3EHarness() = default;

    // ========================================================================
    // Variant Information
    // ========================================================================

    HBM3EVariant variant() const { return variant_; }
    ...
    /// Uses correct clock frequency for the HBM3E variant
