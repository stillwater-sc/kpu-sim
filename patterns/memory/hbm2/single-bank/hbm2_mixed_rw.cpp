// patterns/memory/hbm2/single-bank/hbm2_mixed_rw.cpp
//
// HBM2 single bank mixed read/write pattern
//
...
int main() {
    std::cout << "=== HBM2 Single Bank Mixed R/W Pattern ===" << std::endl;
    ...
    // Export trace
    std::string trace_path = make_trace_path("single-bank", "hbm2_mixed_rw_trace.json");
    harness.export_trace(trace_path);

    std::cout << "\nPASS: HBM2 mixed R/W pattern completed successfully" << std::endl;
    return 0;
}
