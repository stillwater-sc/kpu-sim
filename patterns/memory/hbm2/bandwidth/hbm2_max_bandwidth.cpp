// patterns/memory/hbm2/bandwidth/hbm2_max_bandwidth.cpp
//
// HBM2 maximum bandwidth pattern
...
int main() {
    std::cout << "=== HBM2 Maximum Bandwidth Pattern ===" << std::endl;
    ...
    // Export trace
    std::string trace_path = make_trace_path("bandwidth", "hbm2_max_bandwidth_trace.json");
    harness.export_trace(trace_path);

    std::cout << "\nPASS: HBM2 max bandwidth pattern completed successfully" << std::endl;
    return 0;
}
