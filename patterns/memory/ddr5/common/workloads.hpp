// patterns/memory/ddr5/common/workloads.hpp
//
// Standard workloads for DDR5 pattern testing
//
...
/// Different bank groups workload: banks 0, 8, 16, 24 (one from each BG)
...
inline Workload make_tile_load_workload() {
    ...
    for (int i = 0; i < 64; ++i) {
        uint8_t bank = i % 32;  // Spread across banks
        w.requests.push_back({
...
/// Maximum bandwidth workload: all 32 banks, page hits
