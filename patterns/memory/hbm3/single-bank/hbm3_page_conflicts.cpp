// patterns/memory/hbm3/single-bank/hbm3_page_conflicts.cpp
//
// HBM3 single bank page conflict pattern - reads to different rows
//
...
int main() {
    std::cout << "=== HBM3 Single Bank Page Conflicts Pattern ===" << std::endl;
    ...
    // Export trace
    std::string trace_path = make_trace_path("single-bank", "hbm3_page_conflicts_trace.json");
    harness.export_trace(trace_path);

    std::cout << "\nPASS: HBM3 page conflicts pattern completed successfully" << std::endl;
    return 0;
}
