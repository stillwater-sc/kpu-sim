// patterns/memory/hbm3/pseudo-channel/hbm3_dual_pc.cpp
//
// HBM3 dual pseudo-channel pattern
...
int main() {
    std::cout << "=== HBM3 Dual Pseudo-Channel Pattern ===" << std::endl;
    ...
    // Export trace
    std::string trace_path = make_trace_path("pseudo-channel", "hbm3_dual_pc_trace.json");
    harness.export_trace(trace_path);

    std::cout << "\nPASS: HBM3 dual pseudo-channel pattern completed successfully" << std::endl;
    return 0;
}
