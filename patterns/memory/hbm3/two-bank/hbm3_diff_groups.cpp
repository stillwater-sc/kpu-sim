// patterns/memory/hbm3/two-bank/hbm3_diff_groups.cpp
//
// HBM3 two-bank different bank groups pattern
...
int main() {
    std::cout << "=== HBM3 Two Bank Different Groups Pattern ===" << std::endl;
    ...
    // Export trace
    std::string trace_path = make_trace_path("two-bank", "hbm3_diff_groups_trace.json");
    harness.export_trace(trace_path);

    std::cout << "\nPASS: HBM3 different bank groups pattern completed successfully" << std::endl;
    return 0;
}
