// patterns/memory/gddr7/two-bank/diff_groups.cpp
//
...
bool test_diff_bank_groups() {
    ...
    std::cout << "Configuration: Banks 0 (BG0) and 4 (BG1)" << std::endl;
...
int main(int argc, char* argv[]) {
    std::cout << "=============================================" << std::endl;
    std::cout << "GDDR7 Pattern: Two Banks Different Groups" << std::endl;
    std::cout << "=============================================" << std::endl;
    ...
    if (export_trace) {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            harness.submit_read(make_address(4, 100, i * 64));
        }
