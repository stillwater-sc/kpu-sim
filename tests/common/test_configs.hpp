...
inline KPUSimulator::Config minimal_config() {
    ...
    c.l3_layer.tile_groups      = { {"l3", {64}, 1} };
    c.l2_layer.bank_groups      = { {"l2", {32}, 1} };
    c.l1_layer.buffer_groups    = { {"l1", {32 * 1024}, 1} };
...
inline KPUSimulator::Config small_config() {
    ...
    c.memory_bandwidth_gbps     = 8;
    c.l3_layer.tile_groups      = { {"l3", {256}, 4} };
    c.l2_layer.bank_groups      = { {"l2", {128}, 4} };
    c.l1_layer.buffer_groups    = { {"l1", {64 * 1024}, 2} };
...
inline KPUSimulator::Config medium_config() {
    ...
    c.l3_layer.tile_groups      = { {"l3", {1024}, 4} };
    c.l2_layer.bank_groups      = { {"l2", {512}, 4} };
    c.l1_layer.buffer_groups    = { {"l1", {256 * 1024}, 4} };
